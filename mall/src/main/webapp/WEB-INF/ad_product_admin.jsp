...
<body>
	...
	<ul>
		...
		<li>
			<dl>
				...
				<dd>
					<a href="/mall/admin/query/advertisement/product/1" class="active">Product
						Advertising</a>
				</dd>
			</dl>
		</li>
	...
	<div class="rt_content">
		<div class="page_title">
			<h2 class="fl">Product Advertising</h2>
		</div>
		<table class="table">
			<tr>
			...
			<c:forEach var="product" items="${products}">
				<tr>
					<td class="center">${product.advertisementProductId }</td>
					<td class="center">${product.productId}</td>
					<td class="center">${product.product.productName }</td>
					<td class="center">${product.product.productPrice }</td>
					<td><fmt:formatDate type="both" value="${product.createTime }"/></td>
					<td class="center">${product.price }</td>
					<td> <a href="/mall/admin/agree/advertisement/product/${product.advertisementProductId }" title="approve"
					class="link_icon">&#101;</a> <a href="/mall/admin/refuse/advertisement/product/${product.advertisementProductId }" title="refuse"
					class="link_icon">&#100;</a></td>
				</tr>
			</c:forEach>
		</table>
		<aside class="paging"> <a href="/mall/admin/query/advertisement/product/1">first</a>
		<c:forEach var="page" items="${pages}">
			<a href="/mall/admin/query/advertisement/product/${page}">${page}</a>
		</c:forEach> <a href="/mall/admin/query/advertisement/product/${pages.size()}">end</a> </aside>
	</div>
	</section>
</body>
</html>
