   ...
   <div class="logo_admin" > 
	...
	<ul>
		...
		<li>
			<dl>
				...
				<dd>
					<a href="/mall/admin/query/user/blacklist" class="active">Customer Blacklist</a>
				</dd>
			</dl>
		</li>
		<li>
	...
	<div class="rt_content">
		...
		<input type="text" class="textbox textbox_225"
			placeholder="input customer name" /> <input type="button"
		...
		<table class="table">
			...
			<c:forEach var="user" items="${userList}">
				<tr>
					...
					<td><a href="/mall/admin/remove/user/blacklist/${user.userId }"
						title="remove from blacklist" class="operation">Remove</a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
