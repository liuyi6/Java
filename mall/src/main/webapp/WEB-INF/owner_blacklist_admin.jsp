   ...
   <div class="logo_admin" > 
	...
	<ul>
		<li>
			<dl>
				...
				<dd>
					<a href="/mall/admin/query/shop/blacklist" class="active">Shop Owner Blacklist</a>
				</dd>
			</dl>
		</li>
		<li>
	...
	<div class="rt_content">
		<div class="page_title">
			<h2 class="fl">Owner Blacklist</h2>
		</div>
		<input type="text" class="textbox textbox_225"
			placeholder="input owner/shop name" /> <input type="button"
		...
		<table class="table">
			...
			<c:forEach var="shop" items="${shops}">
				<tr>
					...
					<td><a href="/mall/admin/remove/shop/blacklst/${shop.shopId }" title="move out of blacklist" class="operation">Remove</a>
						<a href="/mall/admin/delete/blacklist/shop/${shop.shopId}" title="delete shop" class="operation">Delete</a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
