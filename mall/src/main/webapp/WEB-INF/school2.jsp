...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/mall/sell/css/bootstrap.css" />
	...
	<script type="text/javascript" src="/mall/sell/js/image.js"></script>
	...
	<script type="text/javascript" src="/mall/sell/js/bootstrap.js"></script>
...
<body style="background-color: #fff">
	...
	<div class="whitebg">
		<div class="normal top2">
			<div class="logo"><a href=""><img src="/mall/sell/images/index/shop_red_64px.png"><h2>PARKnSHOP</h2><p>welcome to PARKnSHOP !</p></a></div>
			<div class="search">
			  <select>
