	...
	<div class="yasi normal" style="border-top:1px solid #DDD;">
		...
		<ul class="pro_search">
			<c:forEach items="${list}" var="shop">
				<li><div><a href="productChoose?id=${shop.shopId}"><img src=""></img></a><a href=""><h1>${shop.shopName}</h1></a><p>$ <span>${shop.shopAddress}</span></p><a href=""><h2>${shop.shopName}</h2></a></div></li>
			</c:forEach>
			</ul>
	  <div class="paging">
       <a>Previous</a>
